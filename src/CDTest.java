...
public class CDTest
{
	...
	public void testGetFormatiertenString()
	{
		assertTrue("Formatierter String enthält Medienbezeichnung",
				_cd1.getFormatiertenString().contains(CD_BEZEICHNUNG));
		assertTrue("Formatierter String enthält TITEL",
				_cd1.getFormatiertenString().contains(TITEL));
		assertTrue("Formatierter String enthält INTERPRET",
				_cd1.getFormatiertenString().contains(INTERPRET));
		assertTrue("Formatierter String enthält KOMMENTAR",
				_cd1.getFormatiertenString().contains(KOMMENTAR));
		assertTrue("Formatierter String enthält Spiellänge",
				_cd1.getFormatiertenString().contains(String.valueOf(LAENGE)));
	}
}
